...
class CConfig():
   ...
   def __init__(self, sCalledBy=None):
      ...
      oCmdLineParser.add_argument('--recreateinstance', action='store_true', help='If True, the EventBusClient class object will be recreated in every iteration; default: False')
